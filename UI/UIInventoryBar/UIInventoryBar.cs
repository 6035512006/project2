...
public class UIInventoryBar : MonoBehaviour
{
    ...
    private void SwitchInventoryBarPosition()
    {
        ...
        if(playerViewportPosition.y > 0.03f && IsInventoryBarPositionBottom == false)
        {
        ...
        else if(playerViewportPosition.y <= 0.03f && IsInventoryBarPositionBottom == true)
        {
